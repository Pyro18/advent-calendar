      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-6 gap-1" style={{
            ...
            <div style={{ gridArea: 'logo' }} className="col-span-2 border border-dashed border-white/70 rounded p-4 bg-black/40">
        ...
        <Dialog open={openDay !== null} onOpenChange={() => setOpenDay(null)}>
          <DialogContent className="sm:max-w-[600px]">
            ...
            <div className="space-y-4">
              <img
                src={openDay && dayContents[openDay]?.image || "/placeholder.svg?height=400&width=600"}
                alt=""
